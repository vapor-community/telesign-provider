...
class PhoneIdTests: XCTestCase {
    func testGetPhoneIdReturnsAProperModel() throws {
        ...
        (try mockRequest.serializedResponse(response: HTTPResponse(headers: headers, body: responseBody), worker: EmbeddedEventLoop()) as Future<TelesignPhoneIdResponse>).do { (phoneResponse) in
